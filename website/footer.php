			...
			<div class="footer-head">
				<div class="col-md-8 footer-top animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
					<ul class=" in">
						...
						<!--<li><a  href="menu.php">Admin-login</a></li>-->
						<li><a  href="contact.php">Contact</a></li>
					</ul>					
<!--					<span style="padding-left: 20px"><h1>Foody</h1></span>-->
				</div>
			...
			<p class="footer-class animated wow bounce" data-wow-duration="1000ms" data-wow-delay="500ms">&copy; 2018 Foody . All Rights Reserved | Design by  <a href="" target="_blank">CMOS</a>|And edited by Gbadamosi oluwseyi </p>
		</div>
	</div>